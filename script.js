                ...
                switch (element.name) {
                    case 'Код ЭКП':
                        for (let j = 1; j < table.rows.length; j++) {
                            ...
                            cell.style.backgroundColor =
                                cell.textContent.includes(filterSetting.ekp)
                    ...
                    case 'Исполнитель':
                        for (let j = 1; j < table.rows.length; j++) {
                            ...
                            if (!cell) break
                            cell.style.backgroundColor =
                                cell.textContent.includes(filterSetting.user)
                    ...
                    case 'Крайний срок завершения':
                        for (let j = 1; j < table.rows.length; j++) {
                            ...
                            if (cell && cell.textContent.length >= 3) {
                                ...
                                if (
                                    differenceInMillis - isOneDayInMillis ===
                                    0
                                ) {
                                    cell.style.backgroundColor =
                                        hour < 11
